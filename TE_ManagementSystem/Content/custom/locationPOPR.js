...
var locationColumns = [{ name: 'Id', minWidth: '100px' }, { name: 'Name', minWidth: '320px' }];
...
$(document).ready(function () {
    ...
    $('#CreateJig').keydown(function (event) {
        if (event.keyCode == 13) {
            $('#CreateJig').trigger('click');
        }
    });
    $('#CreateJig').click(function () {
    ...
    $('#btnCreateNewSupp').click(function () {
        ...
        $("#idnLocation").val(contents);

        contents = $("#NewSupplierName").val();

        $("#location").val(contents);
